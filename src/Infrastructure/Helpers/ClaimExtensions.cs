...
namespace DancePlatform.Infrastructure.Helpers
{
    public static class ClaimsHelper
    {
        ...
        public static async Task<IdentityResult> AddPermissionClaim(this RoleManager<DanceFairAndSquareRole> roleManager, DanceFairAndSquareRole role, string permission)
        {
