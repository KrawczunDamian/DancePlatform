...
using DancePlatform.Application.Specifications.ExtendedAttribute;
using DancePlatform.Domain.Contracts;
using DancePlatform.Domain.Enums;
using DancePlatform.Shared.Wrapper;
using MediatR;
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.Localization;

namespace DancePlatform.Application.Features.ExtendedAttributes.Queries.Export
{
