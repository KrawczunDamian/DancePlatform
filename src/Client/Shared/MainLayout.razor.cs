...
using DancePlatform.Client.Infrastructure.Settings;
...
using DancePlatform.Client.Infrastructure.Managers.Identity.Roles;
using Microsoft.AspNetCore.Components;

namespace DancePlatform.Client.Shared
{
    public partial class MainLayout : IDisposable
    {
        ...
        {
            _currentTheme = DanceFairAndSquareTheme.DefaultTheme;
        ...
        private async Task DarkMode()
        {
            ...
            _currentTheme = isDarkMode
                ? DanceFairAndSquareTheme.DefaultTheme
                : DanceFairAndSquareTheme.DarkTheme;
        }
