...
using DancePlatform.Application.Features.ExtendedAttributes.Commands.Delete;
...
using DancePlatform.Application.Features.ExtendedAttributes.Queries.GetById;
using DancePlatform.Domain.Contracts;
using Microsoft.AspNetCore.Mvc;

namespace DancePlatform.Server.Controllers.Utilities.ExtendedAttributes.Base
{
    /// <summary>
